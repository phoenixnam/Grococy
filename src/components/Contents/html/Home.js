    ...
    return (
        <>
            ...
            <section className="categories" id="categories">
                ...
                <div className="box-container">
                    <a href="/categories/1" className="box">
                        <img src="https://tepbac.com/upload/news/ge_image/2022/09/2_1663666420.jpg" alt="" />
                        <h3>vegetable</h3>
                        <p>upto 45% off</p>
                        <a href="#" className="btn">shop now</a>
                    </a>
                    <a href="/categories/2" className="box">
                        <img src="https://media-cdn-v2.laodong.vn/Storage/NewsPortal/2022/3/19/1025152/Kiem-Tra-Ca-Tuoi-Son-01.jpg" alt="" />
                        <h3>vegitable</h3>
                        <p>upto 45% off</p>
                        <a href="#" className="btn">shop now</a>
                    </a>
                    <a href="/categories/3" className="box">
                        <img src="https://tepbac.com/upload/news/ge_image/2022/09/2_1663666420.jpg" alt="" />
                        <h3>vegetable</h3>
                        <p>upto 45% off</p>
                        <a href="#" className="btn">shop now</a>
                    </a>
                    <a href="/categories/4" className="box">
                        <img src="https://tepbac.com/upload/news/ge_image/2022/09/2_1663666420.jpg" alt="" />
                        <h3>vegitable</h3>
                        <p>upto 45% off</p>
                        <a href="#" className="btn">shop now</a>
                    </a>
                    <a href="/categories/5" className="box">
                        <img src="https://tepbac.com/upload/news/ge_image/2022/09/2_1663666420.jpg" alt="" />
                        <h3>vegitable</h3>
                        <p>upto 45% off</p>
                        <a href="#" className="btn">shop now</a>
